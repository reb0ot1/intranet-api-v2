<?php
/**
 * @var \Employees\Core\ViewInterface $this ...
 * @var \Employees\Core\ViewInterface $message
 */
?>
<style>
    body {
...
<div class="container">
    <div class="row">
        <div class="container" id="formContainer">
            ...
            <form class="form-signin" id="login" role="form" method="post" action="<?= $this->url("users", "loginPost");?>">
...
<!--                            <div class="col-lg-10">-->
<!--                                <input type="text" class="form-control" name="username" id="inputUser" value="" placeholder="User" />-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
